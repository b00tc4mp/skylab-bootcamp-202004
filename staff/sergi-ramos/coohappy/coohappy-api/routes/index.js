...
const { registerUser, authenticate, retrieveUser,registerCohousing, retrieveCohousing, updateUser, updateCohousing, sendMessage, 
    retrieveMessages, joinToCohousing, addFood, substractFood, retrieveUserFoodList, retrieveAllUsersFoodList, addDateLaundry, deleteDateLaundry } = require('./handlers')
