...
const { registerUser, authenticateUser, retrieveUser, createProduct, searchProducts, unregisterUser, updateCart, deleteCart, placeOrder} = require('misc-server-logic')
