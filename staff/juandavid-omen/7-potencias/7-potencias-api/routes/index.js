...
const { registerUser, authenticateUser, retrieveUser, deleteUser, createProduct, searchProducts, updateCart, retrieveCart, deleteCart, placeOrder } = require('./handlers')
