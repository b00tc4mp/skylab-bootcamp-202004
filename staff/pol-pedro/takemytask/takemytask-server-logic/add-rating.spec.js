...
const addRate = require('./add-rating')
const { random } = Math
...
describe('logic - add rate', () => {
    ...
    describe('user exists', () => {
        ...
        it('should succeed on adding rate', async () => {
            await addRate(userId, workerId, rate)
    ...
    describe('chat dont exists', () => {
        ...
        it('sould fail when user id has no chat', async () => {
            ...
            const result = await addRate(userId, fakeId, rate)
                .then()
                .catch(error => {
                    expect(error).to.exist
                    expect(error.message).to.equal(`worker with id ${userId} dont exists`)
                })
