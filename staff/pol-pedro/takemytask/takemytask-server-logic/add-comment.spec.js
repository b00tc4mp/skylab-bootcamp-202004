...
const addComent = require('./add-comment')
const { random } = Math
...
describe('logic - add coment', () => {
    ...
    describe('user exists', () => {
        ...
        it('should succeed on adding coment', async () => {
            await addComent(userId, workerId, coment)
        ...
        it('should succeed on adding coment', async () => {
            try{
                ...
                await addComent(userId, workerId, "")
    ...
    describe('chat dont exists', () => {
        ...
        it('sould fail when user id has no chat', async () => {
            ...
            const result = await addComent(fakeId, fakeId, coment)
                .then()
                .catch(error => {
