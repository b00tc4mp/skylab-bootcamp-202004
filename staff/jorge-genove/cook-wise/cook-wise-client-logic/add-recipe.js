...
module.exports = function (nameRecipe,authorRecipe,description,time,ingredients) {debugger
    ...
    const res = await call(
        ...
        JSON.stringify({name :nameRecipe, author: authorRecipe, description,time, ingredients}),
