            ...
            ingredients.forEach(ingredient => {
                if (groceryList.length) {
                    groceryList.forEach(grocery => {
                        typeof groceryList.find(grocery => grocery.name === ingredient.ingredient.name) !== 'undefined' ?
                            grocery.quantity += ingredient.quantity
                            :
                            groceryList.push({ name: ingredient.ingredient.name, quantity: ingredient.quantity })
                    })

                }

                !groceryList.length && groceryList.push({ name: ingredient.ingredient.name, quantity: ingredient.quantity });
