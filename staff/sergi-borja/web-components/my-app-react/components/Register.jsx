    ...
    render() {
        return <section className="register">
            ...
            <form onSubmit={(event) => { this.handleSubmit(event)}}>
                <input type="text" name="name" placeholder="name" pattern="[A-Za-z]{1,20}" />
                <input type="text" name="surname" placeholder="surname" pattern="[A-Za-z]{1,20}" />
                <input type="email" name="email" placeholder="e-mail" />
                <input type="password" name="password" placeholder="password" minLength="8" />
                <button>Submit</button>
                or <a href="" onClick={event => { event.preventDefault(); this.props.callback('login') }}>Login</a>
