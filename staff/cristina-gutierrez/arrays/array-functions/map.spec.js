...
describe("map", function(){
    it("should iterate on each element of the array, multiply them by 3 and create a new array", function() {
        var arr = [1, 2, 3];
        var result = [];
    ...
    it("should iterate on each element of the array, turn them in upper-case and create a new array", function() {
