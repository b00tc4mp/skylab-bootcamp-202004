describe('registerUser', () => {
    ...
    it('should succeed on correct data', done => {
        registerUser(name, surname, email, password, error => {
            ...
            xhr.open('POST', 'https://skylabcoders.herokuapp.com/api/v2/users/auth')
            ...
            xhr.onload = function () {
                ...
                xhr.open('GET', 'https://skylabcoders.herokuapp.com/api/v2/users')
    ...
    describe('when user already exists', () => {
        beforeEach(done => {
            ...
            xhr.onload = function () {
                if (this.status !== 201) return done(new Error('could not register user'))

                done()
            }

            xhr.onerror = function (error) {
                done(new Error('could not register user'))
            }
