...
class Home extends Component {
    ...
    handleRetrieveHolaNews = () =>
        !this.state.holaNews && retrieveHolaNews((error, news) => {
    ...
    render() {
        return <section className="home">
            ...
            {this.state.view === 'users' && <Users onSearch={this.handleSearchUsers} users={this.state.usersResults} query={this.state.usersQuery} />}
            {this.state.view === 'google' && <Google onSearch={this.handleSearchGoogle} results={this.state.googleResults} query={this.state.googleQuery} />}
            {this.state.view === 'hola-news' && <HolaNews onMount={this.handleRetrieveHolaNews} news={this.state.holaNews} />}
        </section>
    }
}