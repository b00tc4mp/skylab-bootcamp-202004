...
describe('logic - retrieve user', () => {
    ...
    describe('when user already exists', () => {
        ...
        it('should succeed on correct blueprint id', () => {
            ...
            return retrieveBlueprint(token, blueprintId)
                .then(blueprint => {
        ...
        it('should fail on wrong user blueprintId', () => {
            ...
            return retrieveBlueprint(token, '5ed43b913578a050d5600ee0')
        ...
        describe('sync errors', () => {
            ...
            it('on wrong type of data', () => {
                ...
                expect(() => retrieveBlueprint(token, 1)).to.throw(TypeError, '1 is not a string')
                expect(() => retrieveBlueprint(token, "")).to.throw(Error, ' is empty or blank')
