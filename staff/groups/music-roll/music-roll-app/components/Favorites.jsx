    ...
    return <section className="favorites">
        ...
        <section className="favorite__artist">
            ...
            <ul className="favorite__list"> 
                {favorites && favorites.favoriteArtist && favorites.favoriteArtist.map(({images, name}) => {
        ...
        <section className="favorite__album">
            ...
            <ul className="favorite__list"> 
                {favorites && favorites.favoriteAlbum  && favorites.favoriteAlbum.map(({image, name}) => {
                    return  <li className="favorite__items">
                    <h2>{name}</h2>
        ...
        <section className="favorite__track">
            ...
            <ul className="favorite__list"> 
                {favorites && favorites.favoriteTrack && favorites.favoriteTrack.map(({name,artistName, preview_url}) => {
                    return  <li className="favorite__items">
