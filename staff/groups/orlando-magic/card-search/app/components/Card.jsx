    ...
    return<section className="card">
        ...
        <article className="card__content">
            ...
            <ul className="card__content--content">
                ...
                : card.oracle_text.split('\n').map((paragraph, i)=><li key = {i} className="card__content--oracletext">{paragraph}</li>)):(card.card_faces[0].printed_text? card.card_faces[0].printed_text.split('/n').map(paragraph=><p className="card__content--oracletext">{paragraph}</p>)
                : card.card_faces[0].oracle_text.split('\n').map((paragraph, i)=><li key = {i} className="card__content--oracletext">{paragraph}</li>))
                }
