function Search({onAdvancedSearch}){
    ...
    <form onSubmit = {() => {event.preventDefault();onAdvancedSearch(event)}}>
      ...
      <label htmlFor="type">Type Line</label>
      <select id="types">
        <option value = "" />
        ...
        <optgroup label="Artifact Types">
          ...
          <option data-pol="+" data-item="fortification" value="fortification">
            Fortification
          </option>
        ...
        <optgroup label="Planar Types">
          ...
          <option data-pol="+" data-item="serra’s realm" value="serra’s realm">
            Serra’s Realm
          </option>
      ...
      <label htmlFor="stat_1">Stats</label>
      <select id="stat_1">
      ...
      <input type="number" name="statnumber" />
      ...
      <div id="rarity">
        ...
        <label htmlFor="mythicrare">Mythic Rare</label>
      ...
      <input type="text" name="flavortext" id="flavortext" />
      <label htmlFor="lore">Lore:</label>
      <input type="text" name="lore" id="lore" />
      ...
      <label htmlFor="order">Sort Method:</label>
      <select id="order" value="Sort by Name">
      ...
      {/* There are also display options but we may want to ignore them - card images is probably the best */}
      <button>Search with these options</button>
    </form>
  </section>;
