...
class Home extends Component {
    ...
    render() {
        return <section className="home">
            ...
            {this.state.view === 'users' && <Users  token = {this.props.token} onSearch={this.handleSearchUsersResultsAndQuery} users={this.state.usersResults} query={this.state.usersQuery} />}
