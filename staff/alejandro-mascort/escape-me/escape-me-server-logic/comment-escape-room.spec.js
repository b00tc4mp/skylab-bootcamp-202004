...
describe('logic - comment escape room', () => {
    ...
    describe('when userId escapeId and number are correct', () => {
        ...
        it('should succeed on adding the escape room to the correct tag ', async () => {
            ...
            await commentEscapeRoom(userId, escapeId, 'yes')
    ...
    describe('if userId or escapeId are wrong', () => {
        it('should fail when user does not exist', async () => {
            ...
            try {
                await commentEscapeRoom(_userId, escapeId, 'eyee')
        ...
        it('should fail when escape room does not exist', async () => {
            ...
            try {
                await commentEscapeRoom(userId, _escapeId, 'eyee')
                throw new Error('should not reach this point')
            } catch (error) {
                expect(error).to.exist
    ...
    it('should fail when data inputs are wrong', async () => {
        expect(() => {
            commentEscapeRoom(1, '5ee1fa2be1ef46672229f028', 'eyee')
        ...
        expect(() => {
            commentEscapeRoom('5ee1fa2be1ef46672229f028', 1, 'eyee')
        }).to.throw(TypeError, '1 is not a string')

        expect(() => {
            commentEscapeRoom('5ee1fa2be1ef46672229f028', '5ee1fa2be1ef46672229f028', 1)
        }).to.throw(TypeError, '1 is not a string')
