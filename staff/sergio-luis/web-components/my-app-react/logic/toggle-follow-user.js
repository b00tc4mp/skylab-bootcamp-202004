function toggleFollowUser(token,followingId,callback){
    ...
    call('GET', 'https://skylabcoders.herkuapp.com/api/v2/users',undefined,
    {
    ...
    (error, status, body)=>{
        ...
        if( status ===200){
            call('GET', `https://skylabcoders.herokuapp/api/v2/users/${followingId}`,
                undefined,
                {
                    Authorization:`Bearer ${token}`
                },
