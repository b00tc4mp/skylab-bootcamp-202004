...
describe("retrieveAllDeliveryTemplates",()=>{
    ...
    it("should return all the delivery templates with it's name and id", async()=>{
        const templates=await retrieveAllDeliveryTemplates()
    ...
    it("should return an empty array if there are no templates",async()=>{
        await Template.deleteMany()
        const templates= await retrieveAllDeliveryTemplates()
