...
export default function( { goToDetails, onDelete, feedback} ) {

  const [symptomList] = useState(retrieveSubmittedSymptomsFromStorage())
  ...
  return <section className="list">
    ...
    <ul className="list__list">
      {symptomList?<>
        ...
        {!askEmail && <button className="list__symptom--item" onClick = {submitSymptomList}>Submit Symptom List</button>}
        {askEmail && <>
        <p>Would you like us to send the symptom list to your Email?</p>
          <form>
            <input type = "email" name = "email" required = {true} placeholder = "Introduce your e-mail here"></input>
