function calculator(num1, num2) {
    ...
    //If so and num2 is undefined, we do the square root only
        ...
        let rootResult = { SquareRoot : Number.isInteger(Math.sqrt(num1)) ? Math.sqrt(num1) : (Math.sqrt(num1)).toFixed(3)}
    ...
    //If so, we proceed to do the normal operations
        ...
        let results = {Addition: Number.isInteger(num1 + num2) ? num1 + num2 : (num1 + num2).toFixed(3), 
